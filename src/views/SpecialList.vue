      ...
      <div class="container">
        <div class="row vertical-gap">
          <div class="col-lg-8">
            ...
            <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Anime</span> Especiales</span></h3>
            ...
            <div class="nk-tabs">
              ...
              <div class="tab-content">
                <div class="tab-pane fade show active">
                  <div class="nk-gap"></div>
                  <div class="nk-blog-post" v-for="anime in specialList" :key="anime._id">
                    <div class="row vertical-gap">
                      ...
                      <div class="col-lg-9 col-md-7">
                        <router-link :to="{name: 'SpecialVideoSection' , params:{_id: anime._id , title: anime.title}}" class="nk-post-img">
                          <h2 class="nk-post-title h4"><a>{{anime.title}}</a></h2>
                        </router-link>
                        <div class="nk-post-date mt-10 mb-10">
                          <span class="fa fa-angle-double-right"></span> {{anime.type === 'Especial' ? anime.type : 'DESCONOCIDO'}}
                          <span class="fa fa-star-half-alt"></span> <a>{{anime.rating}}</a>
                        </div>
                        <div class="nk-post-text">
                          <p>{{anime.synopsis.substr(12)}}</p>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    setup(){
      ...
      watch(() =>
        sortBy.value.title , (value) =>{
          ...
          store.value.dispatch('GET_ALL_SPECIALS' , {
            sortBy: title,
            page: page.value
          });
        }

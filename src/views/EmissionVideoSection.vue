  ...
  <div class="nk-main">
    ...
    <div class="container">
      <ul class="nk-breadcrumbs">
        <li><span><i class="fab fa-phoenix-squadron"></i> {{anime[0][0].title}}</span></li>
      </ul>
    </div>
    <div class="nk-gap-1"></div>
    <!-- END: Breadcrumbs -->
        ...
        <div class="col-lg-8">
          ...
          <div class="nk-blog-post nk-blog-post-single">
            ...
            <div class="nk-post-text mt-0">
              ...
              <div class="nk-gap"></div>
              <img class="float-left mt-0 nk-post-img" height="200em" :src="anime[0][0].poster.substr(20)" :alt="anime[0][0].title">

            ...
            <div class="nk-tabs">
              ...
              <div class="tab-content">
                <div class="tab-pane fade show active">
                  <div class="nk-gap"></div>
                  <div class="nk-blog-post" v-for="anime in ovaList" :key="anime._id">
                    <div class="row vertical-gap">
                      ...
                      <div class="col-lg-9 col-md-7">
                        <router-link :to="{name: 'OvaVideoSection' , params:{_id: anime._id , title: anime.title}}" class="nk-post-img">

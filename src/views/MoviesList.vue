            ...
            <div class="nk-tabs">
              ...
              <div class="tab-content">
                <div class="tab-pane fade show active">
                  <div class="nk-gap"></div>
                  <div class="nk-blog-post" v-for="movie in allMovies" :key="movie._id">
                    <div class="row vertical-gap">
                      <div class="col-lg-3 col-md-5">
                        <a class="nk-post-img">
                        <img style="height:180px;" :src="movie.poster.substr(20)" :alt="movie.title">
                        <span class="nk-post-categories">
                        </span>
                        </a>
                      </div>
                      <div class="col-lg-9 col-md-7">
                        <router-link :to="{name: 'MovieVideoSection' , params:{_id: movie._id , title: movie.title}}" class="nk-post-img">

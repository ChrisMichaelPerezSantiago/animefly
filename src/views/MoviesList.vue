      ...
      <div class="container">
        <div class="row vertical-gap">
          <div class="col-lg-8">
            ...
            <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Película</span> destacadas</span></h3>
            ...
            <div class="nk-tabs">
              ...
              <div class="tab-content">
                <div class="tab-pane fade show active">
                  <div class="nk-gap"></div>
                  <div class="nk-blog-post" v-for="movie in allMovies" :key="movie.id">
                    <div class="row vertical-gap">
                      <div class="col-lg-3 col-md-5">
                        <a class="nk-post-img">
                        <img style="height:180px;" :src="`data:image/png;base64, ${movie.poster}`" :alt="movie.title">
                        <span class="nk-post-categories">
                        </span>
                        </a>
                      </div>
                      <div class="col-lg-9 col-md-7">
                        <router-link :to="{name: 'MovieVideoSection' , params:{id: movie.id , title: movie.title}}" class="nk-post-img">
                          <h2 class="nk-post-title h4"><a>{{movie.title}}</a></h2>
                        </router-link>
                        <div class="nk-post-date mt-10 mb-10">
                          <span class="fa fa-angle-double-right"></span> {{movie.type === 'Película' ? movie.type : 'DESCONOCIDO'}}
                          <span class="fa fa-star-half-alt"></span> <a>{{movie.rating}}</a>
                        </div>
                        <div class="nk-post-text">
                          <p>{{movie.synopsis.substr(12)}}</p>
                        </div>
                      </div>
                    </div>
                  </div>

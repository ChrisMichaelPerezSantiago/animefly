      ...
      <div class="container">
        <div class="row vertical-gap">
          <div class="col-lg-8">
            ...
            <h3 class="nk-decorated-h-2"><span><span class="text-main-1">Género</span> {{genre}}</span></h3>
                  ...
                  <div class="nk-blog-post" v-for="anime in genreList" :key="anime._id">
                    <div class="row vertical-gap">
                      <div class="col-lg-3 col-md-5">
                        ...
                        <span class="bg-main-1">{{genre}}</span>
                        </span>
                        </a>
                      </div>
    ...
    setup(){
      ...
      watch(() =>
        page.value , (value) =>{
          ...
          const info = {genre: genre.value , sortBy: sortBy.value.title , page: goto}
          init(info)
        }
      );
